...
class RedisAuthorizationCodeServicesTests {
    ...
    void verifyCreateAndConsumeAuthorizationCode() {
        ...
        assertNotSame(this.authentication, authentication,"Authentication object must not be the same!");
        ...
        try {
            ...
            assertThat("Wrong error message!", e.getMessage(), allOf(containsString("Invalid"), containsString(authorizationCode)));
        }
    }
}
